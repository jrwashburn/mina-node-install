#!/bin/bash -x
MINA_VERSION=mina-mainnet=1.2.0beta7-9b5bbaa
ARCHIVE_VERSION=mina-archive-mainnet=1.2.0beta7-9b5bbaa
SIDECAR_VERSION=mina-bp-stats-sidecar=1.2.0beta7-9b5bbaa

#!/bin/bash -x
MINA_VERSION=mina-devnet=1.2.0alpha1-8809560
ARCHIVE_VERSION=mina-archive-devnet=1.2.0alpha1-8809560
SIDECAR_VERSION=mina-bp-stats-sidecar=1.2.0alpha1-8809560-devnet
